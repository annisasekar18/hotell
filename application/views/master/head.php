            ...
            <div class="container">
              <ul>
                ...
                <?php if(!empty($_SESSION['user'])): ?>
                  ...
                  <li class="menu-item  <?=base_url('Resepsionis/Datatrack')?> ">
                    <a href="<?=base_url('Resepsionis/Datatrack')?>?req=Data Traking" class="menu-link">
                      <i class="bi bi-cash"></i>
                      <span>DataTrack</span>
                    </a>
                  </li>
                  <li class="menu-item  <?=base_url('Resepsionis/call')?> ">
                    <a href="<?=base_url('Resepsionis/call')?>?req=Filter Pencarian Data&t=pemesanan&v=filterbyname" class="menu-link">
                      <i class="bi bi-cash"></i>
                  ...
                  <li class="menu-item  <?=base_url('admin/data?v=allcounter&t=users')?> ">
                    <a href="<?=base_url('admin/data?v=allcounter&t=users')?>&req=Data User" class="menu-link">
                      <i class="bi bi-cash"></i>
                      <span>Data User</span>
                    </a>
                  </li>

                  <li class="menu-item  <?=base_url('admin/data?v=allcounter&t=f_kamar')?> ">
                    <a href="<?=base_url('admin/data?v=allcounter&t=f_kamar')?>&req=Data Fasilitas Kamar" class="menu-link">
                      <i class="bi bi-cash"></i>
                      <span>Data Fasilitas Kamar</span>
                    </a>
                  </li>

                  <li class="menu-item  <?=base_url('admin/data?v=allcounter&t=f_hotel')?> ">
                    <a href="<?=base_url('admin/data?v=allcounter&t=f_hotel')?>&req=Data Fasilitas Hotel" class="menu-link">
                      <i class="bi bi-cash"></i>
                      <span>Data Fasilitas Hotel</span>
                    </a>
                  </li>

                  <li class="menu-item  <?=base_url('admin/data?v=allcounter&t=tipe_room')?> ">
                    <a href="<?=base_url('admin/data?v=allcounter&t=tipe_room')?>&req=Data Tipe Kamar" class="menu-link">
                      <i class="bi bi-cash"></i>
                  ...
                  <?php endif ?>
                <li class="menu-item">
                  <a href="<?=base_url('/Tamu/Logout')?>" class='menu-link'>
                    <i class="bi bi-grid-fill"></i>
                    <span>Keluar</span>
                  </a>
                </li>  
                ...
                <li class="menu-item">
                  <a href="<?=base_url('/Resepsionis/Logout')?>" class='menu-link'>
                  </a>
                </li>  
                <?php else:?>
